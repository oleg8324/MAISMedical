...
Partial Public Class Application_Course_Session_Xref
    Public Property Application_Course_Session_Xref1 As Integer
    ...
    Public Overridable Property Application_Course_Xref As Application_Course_Xref
