...
Partial Public Class Person_Course_Session_Xref
    Public Property Person_Course_Session_Xref1 As Integer
    ...
    Public Overridable Property Person_Course_Xref As Person_Course_Xref
