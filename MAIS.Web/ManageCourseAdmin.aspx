<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.master" CodeBehind="ManageCourseAdmin.aspx.vb" Inherits="MAIS.Web.ManageCourseAdmin" %>
<%@ MasterType VirtualPath="~/MasterPage.master" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript" src="Scripts/spin.min.js"></script>
    <script type="text/jscript" src="Scripts/ManageCoursesAdmin.js"></script>
...
<asp:Content ID="Content3" ContentPlaceHolderID="mainContent" runat="server">
    <div >
         <table class="CountySelection" style="width: 100%;">
             <tr>
                <td>
                    <asp:Label ID="Label5" runat="server" Font-Bold="True" Text="Manage Courses Admin"></asp:Label>
                </td>
            </tr>
         </table>
    ...
    <div id="dvNewCourseTable" class="dvNewCourseTable"  style="margin-right: auto; margin-left:auto; width:800px" >
        <table style="width: 100%;">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtEffectiveEndDateNew" runat="server" CssClass="date-pick txtEffectiveEndDate" Width="50%"></asp:TextBox>
                </td>
                <td>
