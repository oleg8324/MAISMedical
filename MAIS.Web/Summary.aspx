<%@ Page Title="Summary" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.master" CodeBehind="Summary.aspx.vb" MaintainScrollPositionOnPostback="true" Inherits="MAIS.Web.Summary" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="mainContent" runat="server">
        ...
        <table class="CountySelection" style="width: 100%;">
                        <tr>
                            <td >                              
                                <asp:Label  ID="Label23" runat="server" Font-Bold="True" Text="Summary Page"></asp:Label> 
                            </td>                                              
                        </tr>
                    </table></center> <br />
